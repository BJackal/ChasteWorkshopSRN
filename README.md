...
Simillar to in Example 1 you can also repalce your ```NoCellCycleModel* p_cc_model = new NoCellCycleModel``` with ```UniformG1GenerationalCellCycleModel* p_cc_model = new UniformG1GenerationalCellCycleModel```. You will also need to uncomment lines 202 - 206. This will allow your cells to grow and divide. On division, the new daughter cells edges will receive a portion of the concentration that existed on the dividing mother cells edge. By default this will be  
